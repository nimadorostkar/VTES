# Generated by Django 3.0.3 on 2022-04-13 01:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_color', to='shop.Product', verbose_name='محصول مربوطه')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='provider_shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shop', to='shop.Shop', verbose_name='فروشگاه ارائه دهنده'),
        ),
    ]
