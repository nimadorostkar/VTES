    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='logos/default.png', null=True, upload_to='brands', verbose_name='لوگو ')),
            ],
            options={
                'verbose_name': 'برند',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('economic_code', models.CharField(blank=True, max_length=120, null=True, verbose_name='کد اقتصادی')),
                ('national_ID', models.CharField(blank=True, max_length=120, null=True, verbose_name='شناسه ملی')),
                ('registration_number', models.CharField(blank=True, max_length=120, null=True, verbose_name='شماره ثبت')),
                ('landline_phone_number', models.CharField(blank=True, max_length=50, null=True, verbose_name='شماره تماس ثابت')),
                ...
                ('central_office_city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='central_office_city', to='shop.City', verbose_name='شهر دفتر مرکزی')),
                ('central_office_province', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='central_office_province', to='shop.Province', verbose_name='استان دفتر مرکزی')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.City', verbose_name='شهر')),
                ('province', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.Province', verbose_name='استان')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.Unit', verbose_name='واحد اندازه گیری')),
            ],
            options={
