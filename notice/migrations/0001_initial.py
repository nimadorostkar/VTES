    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer_status', models.CharField(blank=True, choices=[('accepted', 'accepted'), ('declined', 'declined'), ('changed-value', 'changed-value')], max_length=70, null=True, verbose_name='وضعیت پاسخ')),
